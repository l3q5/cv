...
\begin{enumerate}
  ...
  \item Engineered the system using Angular on the front-end and Python on the back-end, resulting in a 40\% reduction in system downtime and more than 2x the performance.
